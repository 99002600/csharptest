...
namespace Practice
{
    ...
    class SerializationXML
    {
        ...
        {
            Console.WriteLine("What do U want to do : Read or Write(R/W)");
        ...
        private static void serializingXml()
        {
            ...
            Console.WriteLine(" Can You Enter Your Adress?");
            s.Address = Console.ReadLine();
            Console.WriteLine("Enter the Phone Number of 10 digit");
